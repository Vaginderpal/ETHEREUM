# MyToken
 ...
 This is a Solidity that allows for the creation and destruction of tokens, as well as storing information about the token.

## Requirements

1. The contract has public variables that store the details about the coin:
   - `tokenName`: A string that stores the name of the token (e.g., "MSP").
   - `abbrv`: A string that stores the abbreviation of the token (e.g., "MP"). 
